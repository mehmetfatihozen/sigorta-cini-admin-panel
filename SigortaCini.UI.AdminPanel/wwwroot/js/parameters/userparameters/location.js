...
var sigortaCiniUserLocation = {
  ...
  create: function() {
    $("#parameterAdd").click(function() {
      if ($("#parameter_name").val() == "") {
        error("Lokasyon Adını boş geçmeyiniz.");
        return;
      }
      ...
      showLoader();
      $.ajax({
        url: "/UserLocation/CreateUserLocation",
        type: "POST",
        data: {
          UserLocationName: $("#parameter_name").val(),
          State: isActive
        },
        dataType: "json",
  ...
  update: function() {
    $("#parameterUpdate").click(function() {
      ...
      $.ajax({
        ...
        type: "PUT",
        data: {
          UserLocationId: $("#parameterId").val(),
          UserLocationName: $("#parameter_name_update").val(),
  ...
  datatableClick: function() {
    $("#parameter_table tbody").on("click", "tr", function(e) {
      ...
      sigortaCiniUserLocation.get(data.userLocationId);
    });
  },
  ...
  get: function(id) {
    ...
    $.ajax({
      url: "/UserLocation/GetUserLocation",
      type: "GET",
      dataType: "json",
      data: {
        id: id
